...
class MeasureUnitsControllerTest < ActionController::TestCase
  ...
  test "should create measure_unit" do
    assert_difference('MeasureUnit.count') do
      post :create, measure_unit: { cn: @measure_unit.cn, code: @measure_unit.code, describe: @measure_unit.describe, en: @measure_unit.en }
    end
  ...
  test "should update measure_unit" do
    patch :update, id: @measure_unit, measure_unit: { cn: @measure_unit.cn, code: @measure_unit.code, describe: @measure_unit.describe, en: @measure_unit.en }
    assert_redirected_to measure_unit_path(assigns(:measure_unit))
  end
