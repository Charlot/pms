...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { description: @machine.description, name: @machine.name, nr: @machine.nr, resource_group_id: @machine.resource_group_id }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { description: @machine.description, name: @machine.name, nr: @machine.nr, resource_group_id: @machine.resource_group_id }
    assert_redirected_to machine_path(assigns(:machine))
  end
