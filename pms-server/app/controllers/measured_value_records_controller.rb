class MeasuredValueRecordsController < ApplicationController
  ...
  private
    ...
    def measured_value_record_params
      params.require(:measured_value_record).permit(:production_order_id, :part_id, :crimp_height_1, :crimp_height_2, :crimp_height_3, :crimp_height_4, :crimp_height_5, :crimp_width, :i_crimp_heigth, :i_crimp_width, :pulloff_value, :note)
    end
end
