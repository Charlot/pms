...
module FileHandler
  module Csv
    class ProductionOrderItemHandler<Base
      ...
      STATE_EXPORT_CSV_HEADERS=%w(No ItemNr OrderNr State IsUrgent OptimiseIndex Machine  KanbanNr ProductNr KanbanWireNr KanbanQuantity KanbanBundle ProducedQty WireNr Diameter WireLength Terminal1Nr Tool1Nr Terminal1StripLength Terminal2Nr Tool2Nr Terminal2StripLength Seal1Nr Seal2Nr UpdateTime)
